...
| `LIB-001`   | `openedx/edx-platform` (`delete_library`, content libraries v2) | **filed** - [#39117](https://github.com/openedx/openedx-platform/issues/39117), found in the Epic 10 probe — worker libraries cannot be torn down; teardown is best effort |
...
## Epic 10 — Content libraries findings (2026-09-15, planning probe)
...
**Coverage impact:** the `workerLibrary` / `authoringLibrary` fixtures (Epic 10)
